        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-3xl overflow-hidden card-shadow md:flex">
            ...
            <div class="md:w-1/2 p-8 md:p-12">
                <div class="text-center mb-2">
                    <img src="https://via.placeholder.com/150x50?text=Fashion+Frontier" alt="Logo" class="h-12 mx-auto mb-4">
                    <h1 class="text-3xl font-bold text-gray-800">Sign In</h1>
                    <p class="text-gray-600">Access your Fashion Frontier account</p>
                </div>
